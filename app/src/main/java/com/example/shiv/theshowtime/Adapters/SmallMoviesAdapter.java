...
public class SmallMoviesAdapter extends RecyclerView.Adapter<SmallMoviesAdapter.ViewHolder> {
...
onItemClickListener listener;
    ...
    public SmallMoviesAdapter(ArrayList<MovieResults> movieResults, Context mcontext, onItemClickListener listener) {
        this.movieResults = movieResults;
        this.mcontext = mcontext;
        this.listener = listener;
    }

    public SmallMoviesAdapter(ArrayList<MovieResults> movieResults, Context mcontext) {
        this.movieResults = movieResults;
        this.mcontext = mcontext;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
      ...
      View itemView= LayoutInflater.from(parent.getContext())
                     .inflate(R.layout.small_movie_card,parent,false);
