...
fetchmovieslist();
    ...
    progressBar.setVisibility(View.VISIBLE);
        ...
        Call<TmdbClass> call=moviesApi.getlatest();

        call.enqueue(new Callback<TmdbClass>() {
            @Override
            public void onResponse(Call<TmdbClass> call, Response<TmdbClass> response) {

                TmdbClass tmdbClass=response.body();
            ...
            @Override
            public void onFailure(Call<TmdbClass> call, Throwable t) {
